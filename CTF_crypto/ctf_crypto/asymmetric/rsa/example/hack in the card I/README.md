...
We finally managed to let it encrypt a message and captured [voltage variation]('./attachments/index.html') of the resistor during the whole process. Now we are counting on you to do the rest of the work...
